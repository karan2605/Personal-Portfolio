export const projects = [
  {
    title:
      "MedBlock - A Patient Medical Record System using the Ethereum Blockchain",
  ...
  },
  {
    ...
    description:
      "Designing and writing a compiler written in LLVM using C++ for a subset of the C programming language. Involved implementing the language parser, abstract syntax tree and LLVM IR codegen. Compiler also conducts error reporting.",
    key: "llvm",
  },
  {
  ...
  },
  {
    ...
    description:
      "Group Software Project involving the design, development and testing of control software for a motorised buggy to follow a dark line circuit. The software was developed in the C programming language which allowed us to control all registers, actuators and sensors on the buggy. Furthermore, I developed my software engineering skills using waterfall development methodologies.",
    key: "buggy",
  },
  {
    ...
    description:
      "Group software engineering project in partnership with Deutsche Bank. Traditionally, event hosts gained feedback at the end of events preventing them from improving their current even session, the prototype developed by our team alleviates this issue by allowing event hosts to gain live feedback and analytics from event attendees. The prototype was developed as a full stack website to ensure it is easily accessible by all. Event hosts can create forms to distribute to event attendees to complete throughout the event. The website also included sentiment analysis algorithms to then analyse and evaluate the general 'mood' of the attendees from their feedback. The host was provided a dashboard to effectively summarise the analytics data.",
    key: "liveEvent",
  },
];
